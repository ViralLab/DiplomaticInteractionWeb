...
import { countryList } from '@/data/countries/countryNames'
		...
		<div>
			...
			>
				<path
					...
					fill={colors.angola}
					id='AO'
					onMouseEnter={(e) => onPathHover(e.target.getAttribute('name') || '')}
					onClick={onPathClick}
				/>
				<path
				...
				<path
					...
					fill={colors.unitedArabEmirates}
					id='AE'
					onMouseEnter={(e) => onPathHover(e.target.getAttribute('name') || '')}
					onClick={onPathClick}
				/>
				...
				<path
					...
					fill={colors.bosniaAndHerzegovina}
					id='BA'
					onMouseEnter={(e) => onPathHover(e.target.getAttribute('name') || '')}
					onClick={onPathClick}
				/>
				...
				<path
					...
					fill={colors.centralAfricanRepublic}
					id='CF'
					onMouseEnter={(e) => onPathHover(e.target.getAttribute('name') || '')}
					onClick={onPathClick}
				/>
				...
				<path
					...
					fill={colors.federatedStatesOfMicronesia}
					id='FM'
					onMouseEnter={(e) => onPathHover(e.target.getAttribute('name') || '')}
					onClick={onPathClick}
				/>
				...
				<path
					...
					fill={colors.saintKittsAndNevis}
					id='KN'
					onMouseEnter={(e) => onPathHover(e.target.getAttribute('name') || '')}
					onClick={onPathClick}
				/>
				...
				<path
					...
					fill={colors.northernMarianaIslands}
					id='MP'
					onMouseEnter={(e) => onPathHover(e.target.getAttribute('name') || '')}
					onClick={onPathClick}
				/>
				...
				<path
					...
					fill={colors.saoTomeAndPrincipe}
					id='ST'
					onMouseEnter={(e) => onPathHover(e.target.getAttribute('name') || '')}
					onClick={onPathClick}
				/>
				...
				<path
					...
					fill={colors.turksaAndCaicosIslands}
					id='TC'
					onMouseEnter={(e) => onPathHover(e.target.getAttribute('name') || '')}
					onClick={onPathClick}
				/>
				...
				<path
					...
					fill={colors.saintVincentAndTheGrenadines}
					id='VC'
					onMouseEnter={(e) => onPathHover(e.target.getAttribute('name') || '')}
					onClick={onPathClick}
				/>
				<path
					...
					fill={colors.britishVirginIslands}
					id='VG'
					onMouseEnter={(e) => onPathHover(e.target.getAttribute('name') || '')}
					onClick={onPathClick}
				/>
				<path
					...
					fill={colors.unitedStatesVirginIslands}
					id='VI'
					onMouseEnter={(e) => onPathHover(e.target.getAttribute('name') || '')}
					onClick={onPathClick}
				/>
				...
				<path
					...
					className='St. Eustatius And Saba (Netherlands)'
					name='St. Eustatius And Saba (Netherlands)'
					fill={colors.stEustatiusNetherlands}
					id='BQ'
					onMouseEnter={(e) => onPathHover(e.target.getAttribute('name') || '')}
					onClick={onPathClick}
				/>
				...
				<path
					...
					fill={colors.canaryIslandsSpain}
					id='None'
					onMouseEnter={(e) => onPathHover(e.target.getAttribute('name') || '')}
					onClick={onPathClick}
				/>
